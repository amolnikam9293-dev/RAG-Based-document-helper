...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/embeddings/netmind/#setup)
...
## Get Embeddings
[Section titled “Get Embeddings”](https://developers.llamaindex.ai/python/examples/embeddings/netmind/#get-embeddings)
```
