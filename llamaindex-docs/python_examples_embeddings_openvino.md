[Skip to content](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#_top)
...
## Model Exporter
[Section titled “Model Exporter”](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#model-exporter)
...
## Model Loading
[Section titled “Model Loading”](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#model-loading)
...
[Section titled “Model Loading with OpenVINO GenAI”](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#model-loading-with-openvino-genai)
...
[Section titled “OpenClip Model Exporter”](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#openclip-model-exporter)
...
[Section titled “MultiModal Model Loading”](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#multimodal-model-loading)
If you have an Intel GPU, you can specify `device="GPU"` to run inference on it.
```
...
[Section titled “Embed images and queries with OpenVINO”](https://developers.llamaindex.ai/python/examples/embeddings/openvino/#embed-images-and-queries-with-openvino)
```
