[Skip to content](https://developers.llamaindex.ai/python/examples/llm/clarifai/#_top)
# Clarifai LLM 
## Example notebook to call different LLM models using Clarifai
[Section titled “Example notebook to call different LLM models using Clarifai”](https://developers.llamaindex.ai/python/examples/llm/clarifai/#example-notebook-to-call-different-llm-models-using-clarifai)
...
[Section titled “Using Inference parameters”](https://developers.llamaindex.ai/python/examples/llm/clarifai/#using-inference-parameters)
