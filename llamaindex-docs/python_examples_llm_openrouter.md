[Skip to content](https://developers.llamaindex.ai/python/examples/llm/openrouter/#_top)
# OpenRouter 
...
[Section titled “Call chat with ChatMessage List”](https://developers.llamaindex.ai/python/examples/llm/openrouter/#call-chat-with-chatmessage-list)
...
### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/openrouter/#streaming)
```
...
[Section titled “Call complete with Prompt”](https://developers.llamaindex.ai/python/examples/llm/openrouter/#call-complete-with-prompt)
```
...
## Model Configuration
[Section titled “Model Configuration”](https://developers.llamaindex.ai/python/examples/llm/openrouter/#model-configuration)
```
