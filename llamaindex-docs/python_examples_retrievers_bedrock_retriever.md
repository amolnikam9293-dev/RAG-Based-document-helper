[Skip to content](https://developers.llamaindex.ai/python/examples/retrievers/bedrock_retriever/#_top)
...
[Section titled “Using the Knowledge Base Retriever”](https://developers.llamaindex.ai/python/examples/retrievers/bedrock_retriever/#using-the-knowledge-base-retriever)
```
...
[Section titled “Use the retriever to query with Bedrock LLMs”](https://developers.llamaindex.ai/python/examples/retrievers/bedrock_retriever/#use-the-retriever-to-query-with-bedrock-llms)
```
