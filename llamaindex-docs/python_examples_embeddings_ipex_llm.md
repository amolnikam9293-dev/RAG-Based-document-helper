[Skip to content](https://developers.llamaindex.ai/python/examples/embeddings/ipex_llm/#_top)
...
[Section titled “Install llama-index-embeddings-ipex-llm”](https://developers.llamaindex.ai/python/examples/embeddings/ipex_llm/#install-llama-index-embeddings-ipex-llm)
...
## `IpexLLMEmbedding`
[Section titled “IpexLLMEmbedding”](https://developers.llamaindex.ai/python/examples/embeddings/ipex_llm/#ipexllmembedding)
```
