[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama2/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama2/#setup)
...
### Keys
[Section titled “Keys”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama2/#keys)
```
...
[Section titled “Load documents, build the VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama2/#load-documents-build-the-vectorstoreindex)
```
...
## Querying
[Section titled “Querying”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama2/#querying)
```
...
### Streaming Support
[Section titled “Streaming Support”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama2/#streaming-support)
```
