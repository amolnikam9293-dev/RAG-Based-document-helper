[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/supabasevectorindexdemo/#_top)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/supabasevectorindexdemo/#setup-openai)
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/supabasevectorindexdemo/#loading-documents)
...
[Section titled “Create an index backed by Supabase’s vector store.”](https://developers.llamaindex.ai/python/examples/vector_stores/supabasevectorindexdemo/#create-an-index-backed-by-supabases-vector-store)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/supabasevectorindexdemo/#query-the-index)
...
[Section titled “Using metadata filters”](https://developers.llamaindex.ai/python/examples/vector_stores/supabasevectorindexdemo/#using-metadata-filters)
```
