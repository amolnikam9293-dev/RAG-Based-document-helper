[Skip to content](https://developers.llamaindex.ai/python/examples/embeddings/together/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/embeddings/together/#setup)
...
## Get Embeddings
[Section titled “Get Embeddings”](https://developers.llamaindex.ai/python/examples/embeddings/together/#get-embeddings)
```
