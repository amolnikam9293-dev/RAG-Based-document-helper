[Skip to content](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#_top)
...
[Section titled “Setup and Download Data”](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#setup-and-download-data)
...
[Section titled “Building Hybrid Retrieval with Chunk Embedding + Parent Embedding”](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#building-hybrid-retrieval-with-chunk-embedding--parent-embedding)
...
[Section titled “Create Document Store”](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#create-document-store)
...
### Build Vector Index
[Section titled “Build Vector Index”](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#build-vector-index)
...
[Section titled “Define Hybrid Retriever”](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#define-hybrid-retriever)
...
## Run Some Queries
[Section titled “Run Some Queries”](https://developers.llamaindex.ai/python/examples/retrievers/multi_doc_together_hybrid/#run-some-queries)
```
