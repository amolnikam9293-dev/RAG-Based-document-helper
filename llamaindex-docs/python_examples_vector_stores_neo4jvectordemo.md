[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/neo4jvectordemo/#_top)
# Neo4j vector store 
...
[Section titled “Initiate Neo4j vector wrapper”](https://developers.llamaindex.ai/python/examples/vector_stores/neo4jvectordemo/#initiate-neo4j-vector-wrapper)
```
...
[Section titled “Load documents, build the VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/neo4jvectordemo/#load-documents-build-the-vectorstoreindex)
```
...
## Hybrid search
[Section titled “Hybrid search”](https://developers.llamaindex.ai/python/examples/vector_stores/neo4jvectordemo/#hybrid-search)
...
[Section titled “Load existing vector index”](https://developers.llamaindex.ai/python/examples/vector_stores/neo4jvectordemo/#load-existing-vector-index)
...
[Section titled “Customizing responses”](https://developers.llamaindex.ai/python/examples/vector_stores/neo4jvectordemo/#customizing-responses)
