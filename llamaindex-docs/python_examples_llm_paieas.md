[Skip to content](https://developers.llamaindex.ai/python/examples/llm/paieas/#_top)
# AlibabaCloud-PaiEas 
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/paieas/#basic-usage)
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/paieas/#call-complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/paieas/#call-chat-with-a-list-of-messages)
```
...
## Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/paieas/#streaming)
...
## Async
[Section titled “Async”](https://developers.llamaindex.ai/python/examples/llm/paieas/#async)
```
