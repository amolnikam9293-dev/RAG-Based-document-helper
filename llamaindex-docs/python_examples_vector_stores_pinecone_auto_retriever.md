[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#_top)
...
[Section titled “Part 1: Setup Auto-Retrieval”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#part-1-setup-auto-retrieval)
...
[Section titled “1.a Setup Pinecone/Phoenix, Load Data, and Build Vector Index”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#1a-setup-pineconephoenix-load-data-and-build-vector-index)
...
[Section titled “Load documents, build the PineconeVectorStore and VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#load-documents-build-the-pineconevectorstore-and-vectorstoreindex)
```
...
[Section titled “1.b Define Autoretriever, Run Some Sample Queries”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#1b-define-autoretriever-run-some-sample-queries)
#### Setup the `VectorIndexAutoRetriever`
[Section titled “Setup the VectorIndexAutoRetriever”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#setup-the-vectorindexautoretriever)
...
[Section titled “Let’s run some queries”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#lets-run-some-queries)
...
[Section titled “Pass in Additional Metadata Filters”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#pass-in-additional-metadata-filters)
...
[Section titled “Example of a failing Query”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#example-of-a-failing-query)
...
### Visualize Traces
[Section titled “Visualize Traces”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#visualize-traces)
...
[Section titled “Part 2: Extending Auto-Retrieval (with Dynamic Metadata Retrieval)”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#part-2-extending-auto-retrieval-with-dynamic-metadata-retrieval)
...
[Section titled “2.a Improve the Auto-retrieval Prompt”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#2a-improve-the-auto-retrieval-prompt)
...
[Section titled “Customize the Prompt”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#customize-the-prompt)
...
#### Re-run some queries
[Section titled “Re-run some queries”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#re-run-some-queries)
...
[Section titled “2.b Implement Dynamic Metadata Retrieval”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#2b-implement-dynamic-metadata-retrieval)
...
#### Re-run some queries
[Section titled “Re-run some queries”](https://developers.llamaindex.ai/python/examples/vector_stores/pinecone_auto_retriever/#re-run-some-queries-1)
Now let’s try rerunning some queries, and we’ll see that the value is auto-inferred.
```
