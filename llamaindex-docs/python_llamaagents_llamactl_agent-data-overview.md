[Skip to content](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-overview/#_top)
# Agent Data
### What is Agent Data?
[Section titled “What is Agent Data?”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-overview/#what-is-agent-data)
...
### Filter DSL
[Section titled “Filter DSL”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-overview/#filter-dsl)
...
[Section titled “ExtractedData wrapper”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-overview/#extracteddata-wrapper)
...
Next steps:
  * Python usage: see [Agent Data (Python)](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-python)
  * JavaScript usage: see [Agent Data (JavaScript)](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript)
