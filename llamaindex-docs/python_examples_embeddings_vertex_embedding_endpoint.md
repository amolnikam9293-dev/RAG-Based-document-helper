[Skip to content](https://developers.llamaindex.ai/python/examples/embeddings/vertex_embedding_endpoint/#_top)
...
## Setting Up
[Section titled “Setting Up”](https://developers.llamaindex.ai/python/examples/embeddings/vertex_embedding_endpoint/#setting-up)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/embeddings/vertex_embedding_endpoint/#basic-usage)
### Call `get_text_embedding`
[Section titled “Call get_text_embedding”](https://developers.llamaindex.ai/python/examples/embeddings/vertex_embedding_endpoint/#call-get_text_embedding)
```
...
[Section titled “Call get_text_embedding_batch”](https://developers.llamaindex.ai/python/examples/embeddings/vertex_embedding_endpoint/#call-get_text_embedding_batch)
```
