[Skip to content](https://developers.llamaindex.ai/python/examples/llm/opus_4_1/#_top)
...
[Section titled “Build an LLM-based assistant with Opus 4.1”](https://developers.llamaindex.ai/python/examples/llm/opus_4_1/#build-an-llm-based-assistant-with-opus-41)
...
[Section titled “Build an agent with Opus 4.1”](https://developers.llamaindex.ai/python/examples/llm/opus_4_1/#build-an-agent-with-opus-41)
...
If you want more content around Anthropic, make sure to check out our [general example notebook](https://developers.llamaindex.ai/python/examples/llm/opus_4_1/anthropic.ipynb)
