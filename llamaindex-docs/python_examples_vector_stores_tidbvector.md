[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/tidbvector/#_top)
# TiDB Vector Store 
...
[Section titled “Setting up environments”](https://developers.llamaindex.ai/python/examples/vector_stores/tidbvector/#setting-up-environments)
```
...
[Section titled “Create TiDB Vectore Store”](https://developers.llamaindex.ai/python/examples/vector_stores/tidbvector/#create-tidb-vectore-store)
...
[Section titled “Semantic similarity search”](https://developers.llamaindex.ai/python/examples/vector_stores/tidbvector/#semantic-similarity-search)
...
[Section titled “Filter with metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/tidbvector/#filter-with-metadata)
...
## Delete documents
[Section titled “Delete documents”](https://developers.llamaindex.ai/python/examples/vector_stores/tidbvector/#delete-documents)
```
