[Skip to content](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript/#_top)
...
### Create client
[Section titled “Create client”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript/#create-client)
...
### CRUD operations
[Section titled “CRUD operations”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript/#crud-operations)
```
...
### Delete by query
[Section titled “Delete by query”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript/#delete-by-query)
...
### Search
[Section titled “Search”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript/#search)
```
...
See the [Agent Data Overview](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-overview#filter-dsl) for more details on filters.
...
### Aggregate
[Section titled “Aggregate”](https://developers.llamaindex.ai/python/llamaagents/llamactl/agent-data-javascript/#aggregate)
```
