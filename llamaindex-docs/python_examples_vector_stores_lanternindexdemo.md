[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#_top)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#setup-openai)
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#loading-documents)
...
### Create the Database
[Section titled “Create the Database”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#create-the-database)
...
### Create the index
[Section titled “Create the index”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#create-the-index)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#query-the-index)
...
[Section titled “Querying existing index”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#querying-existing-index)
```
...
### Hybrid Search
[Section titled “Hybrid Search”](https://developers.llamaindex.ai/python/examples/vector_stores/lanternindexdemo/#hybrid-search)
