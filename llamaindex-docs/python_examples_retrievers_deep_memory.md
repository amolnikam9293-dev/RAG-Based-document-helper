[Skip to content](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#_top)
...
The tutorial can be divided into several parts:
  1. [Dataset creation and uploading](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#1-dataset-creation-and-ingestion)
  2. [Generating synthetic queries and training deep_memory](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#2-training-deep-memory)
  3. [Evaluating deep memory performance](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#3-deepmemory-evaluation)
  4. [Deep Memory inference](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#4-deep-memory-inference)


## 1. Dataset Creation and ingestion
[Section titled “1. Dataset Creation and ingestion”](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#1-dataset-creation-and-ingestion)
...
[Section titled “2. Training Deep Memory”](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#2-training-deep-memory)
...
[Section titled “3. DeepMemory Evaluation”](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#3-deepmemory-evaluation)
...
[Section titled “4. Deep Memory Inference”](https://developers.llamaindex.ai/python/examples/retrievers/deep_memory/#4-deep-memory-inference)
```
