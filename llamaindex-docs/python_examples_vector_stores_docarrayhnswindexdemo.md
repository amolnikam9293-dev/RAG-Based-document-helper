[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayhnswindexdemo/#_top)
...
[Section titled “Initialization and indexing”](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayhnswindexdemo/#initialization-and-indexing)
```
...
## Querying
[Section titled “Querying”](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayhnswindexdemo/#querying)
```
...
[Section titled “Querying with filters”](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayhnswindexdemo/#querying-with-filters)
```
