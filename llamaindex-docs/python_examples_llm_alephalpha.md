[Skip to content](https://developers.llamaindex.ai/python/examples/llm/alephalpha/#_top)
# Aleph Alpha 
...
[Section titled “Set your Aleph Alpha token”](https://developers.llamaindex.ai/python/examples/llm/alephalpha/#set-your-aleph-alpha-token)
```
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/alephalpha/#call-complete-with-a-prompt)
```
...
[Section titled “Additional Response Details”](https://developers.llamaindex.ai/python/examples/llm/alephalpha/#additional-response-details)
...
## Async
[Section titled “Async”](https://developers.llamaindex.ai/python/examples/llm/alephalpha/#async)
```
