[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#_top)
...
### Start Dragonfly
[Section titled “Start Dragonfly”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#start-dragonfly)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#setup-openai)
...
### Read in a dataset
[Section titled “Read in a dataset”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#read-in-a-dataset)
...
[Section titled “Initialize the default vector store”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#initialize-the-default-vector-store)
...
[Section titled “Query the default vector store”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#query-the-default-vector-store)
...
[Section titled “Use a custom index schema”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#use-a-custom-index-schema)
...
[Section titled “Query the vector store and filter on metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#query-the-vector-store-and-filter-on-metadata)
...
[Section titled “Deleting documents or index completely”](https://developers.llamaindex.ai/python/examples/vector_stores/dragonflyindexdemo/#deleting-documents-or-index-completely)
