[Skip to content](https://developers.llamaindex.ai/python/examples/llm/friendli/#_top)
# Friendli 
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/friendli/#basic-usage)
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/friendli/#call-chat-with-a-list-of-messages)
```
...
#### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/friendli/#streaming)
```
...
#### Async
[Section titled “Async”](https://developers.llamaindex.ai/python/examples/llm/friendli/#async)
```
...
#### Async Streaming
[Section titled “Async Streaming”](https://developers.llamaindex.ai/python/examples/llm/friendli/#async-streaming)
```
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/friendli/#call-complete-with-a-prompt)
```
...
#### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/friendli/#streaming-1)
```
...
#### Async
[Section titled “Async”](https://developers.llamaindex.ai/python/examples/llm/friendli/#async-1)
```
...
#### Async Streaming
[Section titled “Async Streaming”](https://developers.llamaindex.ai/python/examples/llm/friendli/#async-streaming-1)
```
...
## Configure Model
[Section titled “Configure Model”](https://developers.llamaindex.ai/python/examples/llm/friendli/#configure-model)
```
