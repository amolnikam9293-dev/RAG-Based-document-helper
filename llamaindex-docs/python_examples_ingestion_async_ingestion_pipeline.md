...
returnIngestionPipeline(transformations=transformations)
...
print(f"Average time: (times)/(times)}")
...
TitleExtractor=llm,metadata_mode=MetadataMode.EMBED),




SummaryExtractor=llm,metadata_mode=MetadataMode.EMBED),
