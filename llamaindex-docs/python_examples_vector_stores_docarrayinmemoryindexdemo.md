[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayinmemoryindexdemo/#_top)
...
[Section titled “Initialization and indexing”](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayinmemoryindexdemo/#initialization-and-indexing)
```
...
## Querying
[Section titled “Querying”](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayinmemoryindexdemo/#querying)
```
...
[Section titled “Querying with filters”](https://developers.llamaindex.ai/python/examples/vector_stores/docarrayinmemoryindexdemo/#querying-with-filters)
```
