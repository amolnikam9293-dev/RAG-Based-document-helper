[Skip to content](https://developers.llamaindex.ai/python/examples/llm/llama_api/#_top)
# Llama API 
[Llama API](https://www.llama-api.com/) is a hosted API for Llama 2 with function calling support.
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/llm/llama_api/#setup)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/llama_api/#basic-usage)
#### Call `complete` with a prompt
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/llama_api/#call-complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/llama_api/#call-chat-with-a-list-of-messages)
```
...
## Function Calling
[Section titled “Function Calling”](https://developers.llamaindex.ai/python/examples/llm/llama_api/#function-calling)
```
...
[Section titled “Structured Data Extraction”](https://developers.llamaindex.ai/python/examples/llm/llama_api/#structured-data-extraction)
