[Skip to content](https://developers.llamaindex.ai/python/examples/llm/anthropic/#_top)
# Anthropic 
...
#### Set Tokenizer
[Section titled “Set Tokenizer”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#set-tokenizer)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#basic-usage)
```
...
## Streaming Support
[Section titled “Streaming Support”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#streaming-support)
...
## Async Usage
[Section titled “Async Usage”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#async-usage)
...
## Vertex AI Support
[Section titled “Vertex AI Support”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#vertex-ai-support)
...
## Bedrock Support
[Section titled “Bedrock Support”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#bedrock-support)
...
## Multi-Modal Support
[Section titled “Multi-Modal Support”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#multi-modal-support)
...
## Prompt Caching
[Section titled “Prompt Caching”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#prompt-caching)
...
[Section titled “Structured Prediction”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#structured-prediction)
...
[Section titled “Structured Prediction with Streaming”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#structured-prediction-with-streaming)
...
## Model Thinking
[Section titled “Model Thinking”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#model-thinking)
...
[Section titled “Tool/Function Calling”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#toolfunction-calling)
...
[Section titled “Server-Side Tool Calling”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#server-side-tool-calling)
...
[Section titled “Tool Calling + Citations”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#tool-calling--citations)
...
[Section titled “Agents + Citable Tools”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#agents--citable-tools)
...
[Section titled “Manual Tool Calling + Citations”](https://developers.llamaindex.ai/python/examples/llm/anthropic/#manual-tool-calling--citations)
