[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#_top)
# Jaguar Vector Store 
...
## Prerequisites
[Section titled “Prerequisites”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#prerequisites)
...
## Imports
[Section titled “Imports”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#imports)
...
## Client Object
[Section titled “Client Object”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#client-object)
...
## Authentication
[Section titled “Authentication”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#authentication)
...
## Create Vector Store
[Section titled “Create Vector Store”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#create-vector-store)
...
## Load Documents
[Section titled “Load Documents”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#load-documents)
...
## Make Index
[Section titled “Make Index”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#make-index)
...
## Ask Questions
[Section titled “Ask Questions”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#ask-questions)
...
## Pass Query Options
[Section titled “Pass Query Options”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#pass-query-options)
...
## Cleanup and Logout
[Section titled “Cleanup and Logout”](https://developers.llamaindex.ai/python/examples/vector_stores/jaguarindexdemo/#cleanup-and-logout)
