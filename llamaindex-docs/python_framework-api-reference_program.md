# Index
##  BaseOutputParser [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.BaseOutputParser "Permanent link")
...
---|---  
###  parse `abstractmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.BaseOutputParser.parse "Permanent link")
```
parse(output: ) -> 
...
---|---  
###  format [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.BaseOutputParser.format "Permanent link")
```
format(query: ) -> 
...
---|---  
###  format_messages [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.BaseOutputParser.format_messages "Permanent link")
```
...
---|---  
##  BasePydanticProgram [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.BasePydanticProgram "Permanent link")
...
---|---  
##  PydanticProgramMode [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.PydanticProgramMode "Permanent link")
Bases: `str`, `Enum`
...
---|---  
##  Thread [#](https://developers.llamaindex.ai/python/framework-api-reference/program/#llama_index.core.types.Thread "Permanent link")
Bases: `Thread`
...
---|---  
options: members: - BasePydanticProgram
