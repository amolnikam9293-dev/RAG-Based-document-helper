[Skip to content](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#_top)
...
## Load Data
[Section titled “Load Data”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#load-data)
...
[Section titled “Parse Chunk Hierarchy from Text, Load into Storage”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#parse-chunk-hierarchy-from-text-load-into-storage)
...
### Load into Storage
[Section titled “Load into Storage”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#load-into-storage)
...
## Define Retriever
[Section titled “Define Retriever”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#define-retriever)
```
...
[Section titled “Plug it into Query Engine”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#plug-it-into-query-engine)
```
...
## Evaluation
[Section titled “Evaluation”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#evaluation)
...
### Compare Results
[Section titled “Compare Results”](https://developers.llamaindex.ai/python/examples/retrievers/auto_merging_retriever/#compare-results)
