[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#_top)
...
[Section titled “What is Timescale Vector?”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#what-is-timescale-vector)
...
[Section titled “How to use Timescale Vector”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#how-to-use-timescale-vector)
...
## 0. Setup
[Section titled “0. Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#0-setup)
...
[Section titled “Setup OpenAI API Key”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#setup-openai-api-key)
...
[Section titled “Create a PostgreSQL database and get a Timescale service URL”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#create-a-postgresql-database-and-get-a-timescale-service-url)
...
[Section titled “1. Simple Similarity Search with Timescale Vector”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#1-simple-similarity-search-with-timescale-vector)
### Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#download-data)
```
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#loading-documents)
...
[Section titled “Create a VectorStore Index with the TimescaleVectorStore”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#create-a-vectorstore-index-with-the-timescalevectorstore)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#query-the-index)
...
[Section titled “Querying existing index”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#querying-existing-index)
...
[Section titled “2. Using ANN search indexes to speed up queries”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#2-using-ann-search-indexes-to-speed-up-queries)
...
[Section titled “3. Similarity Search with time-based filtering”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#3-similarity-search-with-time-based-filtering)
...
[Section titled “Extract content and metadata from git log CSV file”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#extract-content-and-metadata-from-git-log-csv-file)
...
[Section titled “Load documents and metadata into TimescaleVector vectorstore”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#load-documents-and-metadata-into-timescalevector-vectorstore)
...
[Section titled “Querying vectors by time and similarity”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#querying-vectors-by-time-and-similarity)
...
[Section titled “4. Using TimescaleVector store as a Retriever and Query engine”](https://developers.llamaindex.ai/python/examples/vector_stores/timescalevector/#4-using-timescalevector-store-as-a-retriever-and-query-engine)
