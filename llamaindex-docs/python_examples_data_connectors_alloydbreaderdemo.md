[Skip to content](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#_top)
...
## Before you begin
[Section titled “Before you begin”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#before-you-begin)
...
[Section titled “🦙 Library Installation”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#-library-installation)
...
### 🔐 Authentication
[Section titled “🔐 Authentication”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#-authentication)
...
[Section titled “☁ Set Your Google Cloud Project”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#-set-your-google-cloud-project)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#basic-usage)
### Set AlloyDB database values
[Section titled “Set AlloyDB database values”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#set-alloydb-database-values)
...
[Section titled “AlloyDBEngine Connection Pool”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#alloydbengine-connection-pool)
...
[Section titled “Create AlloyDBReader”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#create-alloydbreader)
...
[Section titled “Load Documents using the table_name argument”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#load-documents-using-the-table_name-argument)
#### Load Documents via default table
[Section titled “Load Documents via default table”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#load-documents-via-default-table)
...
[Section titled “Load documents via custom table/metadata or custom page content columns”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#load-documents-via-custom-tablemetadata-or-custom-page-content-columns)
```
...
[Section titled “Load Documents using a SQL query”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#load-documents-using-a-sql-query)
...
[Section titled “Set page content format”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#set-page-content-format)
...
### Load the documents
[Section titled “Load the documents”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#load-the-documents)
...
[Section titled “Load data all at once”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#load-data-all-at-once)
```
...
#### Lazy Load the data
[Section titled “Lazy Load the data”](https://developers.llamaindex.ai/python/examples/data_connectors/alloydbreaderdemo/#lazy-load-the-data)
```
