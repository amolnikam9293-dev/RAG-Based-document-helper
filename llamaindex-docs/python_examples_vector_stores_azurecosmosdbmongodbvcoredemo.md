[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/azurecosmosdbmongodbvcoredemo/#_top)
...
### Setup Azure OpenAI
[Section titled “Setup Azure OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/azurecosmosdbmongodbvcoredemo/#setup-azure-openai)
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/azurecosmosdbmongodbvcoredemo/#loading-documents)
...
### Create the index
[Section titled “Create the index”](https://developers.llamaindex.ai/python/examples/vector_stores/azurecosmosdbmongodbvcoredemo/#create-the-index)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/azurecosmosdbmongodbvcoredemo/#query-the-index)
