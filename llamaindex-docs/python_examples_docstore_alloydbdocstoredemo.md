...
## Before you begin
[Section titled “Before you begin”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#before-you-begin)
...
[Section titled “🦙 Library Installation”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#-library-installation)
...
### 🔐 Authentication
[Section titled “🔐 Authentication”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#-authentication)
...
[Section titled “☁ Set Your Google Cloud Project”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#-set-your-google-cloud-project)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#basic-usage)
### Set AlloyDB database values
[Section titled “Set AlloyDB database values”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#set-alloydb-database-values)
...
[Section titled “AlloyDBEngine Connection Pool”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#alloydbengine-connection-pool)
...
[Section titled “AlloyDBEngine for AlloyDB Omni”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#alloydbengine-for-alloydb-omni)
...
### Initialize a table
[Section titled “Initialize a table”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#initialize-a-table)
...
#### Optional Tip: 💡
[Section titled “Optional Tip: 💡”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#optional-tip)
...
[Section titled “Initialize a default AlloyDBDocumentStore”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#initialize-a-default-alloydbdocumentstore)
```
...
### Download data
[Section titled “Download data”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#download-data)
```
...
### Load documents
[Section titled “Load documents”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#load-documents)
```
...
### Parse into nodes
[Section titled “Parse into nodes”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#parse-into-nodes)
```
...
[Section titled “Set up an IndexStore”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#set-up-an-indexstore)
```
...
### Add to Docstore
[Section titled “Add to Docstore”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#add-to-docstore)
```
...
## Use with Indexes
[Section titled “Use with Indexes”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#use-with-indexes)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#query-the-index)
```
...
[Section titled “Load existing indexes”](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo/#load-existing-indexes)
The Document Store can be used with multiple indexes. Each index uses the same underlying nodes.
```
