...
[Section titled “Creating a Weaviate Client”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#creating-a-weaviate-client)
```
...
[Section titled “Load documents, build the VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#load-documents-build-the-vectorstoreindex)
```
...
[Section titled “Using a custom batch configuration”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#using-a-custom-batch-configuration)
...
#### Query Index
[Section titled “Query Index”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#query-index)
```
...
## Loading the index
[Section titled “Loading the index”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#loading-the-index)
...
## Metadata Filtering
[Section titled “Metadata Filtering”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#metadata-filtering)
...
[Section titled “Deleting the index completely”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#deleting-the-index-completely)
...
[Section titled “Connection Termination”](https://developers.llamaindex.ai/python/examples/vector_stores/weaviateindexdemo/#connection-termination)
