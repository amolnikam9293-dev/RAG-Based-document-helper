[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_demo/#_top)
# Elasticsearch 
> [Elasticsearch](http://www.github.com/elastic/elasticsearch) is a search database, that supports full text and vector searches.
## Basic Example
[Section titled “Basic Example”](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_demo/#basic-example)
