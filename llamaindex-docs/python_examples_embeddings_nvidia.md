[Skip to content](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#_top)
# NVIDIA NIMs 
...
## Installation
[Section titled “Installation”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#installation)
```
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#setup)
**To get started:**
...
[Section titled “Working with NVIDIA API Catalog”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#working-with-nvidia-api-catalog)
...
[Section titled “Working with NVIDIA NIMs”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#working-with-nvidia-nims)
...
### **Similarity**
[Section titled “Similarity”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#similarity)
...
### Embedding queries
[Section titled “Embedding queries”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#embedding-queries)
```
...
### Document Embedding
[Section titled “Document Embedding”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#document-embedding)
```
...
## Truncation
[Section titled “Truncation”](https://developers.llamaindex.ai/python/examples/embeddings/nvidia/#truncation)
