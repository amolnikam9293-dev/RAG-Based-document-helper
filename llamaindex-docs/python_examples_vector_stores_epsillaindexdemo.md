[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/epsillaindexdemo/#_top)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/epsillaindexdemo/#setup-openai)
...
### Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/vector_stores/epsillaindexdemo/#download-data)
```
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/epsillaindexdemo/#loading-documents)
...
### Create the index
[Section titled “Create the index”](https://developers.llamaindex.ai/python/examples/vector_stores/epsillaindexdemo/#create-the-index)
...
### Query the data
[Section titled “Query the data”](https://developers.llamaindex.ai/python/examples/vector_stores/epsillaindexdemo/#query-the-data)
