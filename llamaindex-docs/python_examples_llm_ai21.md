[Skip to content](https://developers.llamaindex.ai/python/examples/llm/ai21/#_top)
# AI21 
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/ai21/#basic-usage)
...
[Section titled “Setting the AI21 API Key”](https://developers.llamaindex.ai/python/examples/llm/ai21/#setting-the-ai21-api-key)
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/ai21/#call-chat-with-a-list-of-messages)
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/ai21/#call-complete-with-a-prompt)
```
...
## Call Async Methods
[Section titled “Call Async Methods”](https://developers.llamaindex.ai/python/examples/llm/ai21/#call-async-methods)
```
...
[Section titled “Adjust the model behavior”](https://developers.llamaindex.ai/python/examples/llm/ai21/#adjust-the-model-behavior)
...
## Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/ai21/#streaming)
...
## Tokenizer
[Section titled “Tokenizer”](https://developers.llamaindex.ai/python/examples/llm/ai21/#tokenizer)
...
## Tool Calling
[Section titled “Tool Calling”](https://developers.llamaindex.ai/python/examples/llm/ai21/#tool-calling)
```
