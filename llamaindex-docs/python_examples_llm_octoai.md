...
[Section titled “Initialize the Integration with the default model”](https://developers.llamaindex.ai/python/examples/llm/octoai/#initialize-the-integration-with-the-default-model)
```
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/octoai/#call-complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/octoai/#call-chat-with-a-list-of-messages)
```
...
## Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/octoai/#streaming)
...
## Configure Model
[Section titled “Configure Model”](https://developers.llamaindex.ai/python/examples/llm/octoai/#configure-model)
```
