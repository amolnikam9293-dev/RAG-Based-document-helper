[Skip to content](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#_top)
# VoyageAI Embeddings 
...
[Section titled “With latest voyage-3 embeddings.”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#with-latest-voyage-3-embeddings)
...
[Section titled “Let’s check With int8 embedding_type with voyage-3-large model”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#lets-check-with-int8-embedding_type-with-voyage-3-large-model)
```
...
[Section titled “Check voyage-3-large embeddings in depth”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#check-voyage-3-large-embeddings-in-depth)
...
#### Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#download-data)
```
...
#### Load Data
[Section titled “Load Data”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#load-data)
```
...
[Section titled “With int8 embedding_type”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#with-int8-embedding_type)
#### Build index
[Section titled “Build index”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#build-index)
```
...
#### Build retriever
[Section titled “Build retriever”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#build-retriever)
```
...
[Section titled “Text-Image Embeddings”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#text-image-embeddings)
...
##### Image Embeddings
[Section titled “Image Embeddings”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#image-embeddings)
```
...
##### Text Embeddings
[Section titled “Text Embeddings”](https://developers.llamaindex.ai/python/examples/embeddings/voyageai/#text-embeddings)
```
