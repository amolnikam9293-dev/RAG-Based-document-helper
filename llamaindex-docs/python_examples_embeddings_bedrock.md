...
[Section titled “List supported models”](https://developers.llamaindex.ai/python/examples/embeddings/bedrock/#list-supported-models)
...
## Provider: Amazon
[Section titled “Provider: Amazon”](https://developers.llamaindex.ai/python/examples/embeddings/bedrock/#provider-amazon)
...
## Provider: Cohere
[Section titled “Provider: Cohere”](https://developers.llamaindex.ai/python/examples/embeddings/bedrock/#provider-cohere)
### cohere.embed-english-v3
[Section titled “cohere.embed-english-v3”](https://developers.llamaindex.ai/python/examples/embeddings/bedrock/#cohereembed-english-v3)
```
...
[Section titled “MultiLingual Embeddings from Cohere”](https://developers.llamaindex.ai/python/examples/embeddings/bedrock/#multilingual-embeddings-from-cohere)
```
