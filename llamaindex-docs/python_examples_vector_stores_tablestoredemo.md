[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/tablestoredemo/#_top)
...
## Install
[Section titled “Install”](https://developers.llamaindex.ai/python/examples/vector_stores/tablestoredemo/#install)
```
...
## Example
[Section titled “Example”](https://developers.llamaindex.ai/python/examples/vector_stores/tablestoredemo/#example)
Create vector store.
```
