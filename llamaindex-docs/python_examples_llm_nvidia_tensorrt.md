[Skip to content](https://developers.llamaindex.ai/python/examples/llm/nvidia_tensorrt/#_top)
# Nvidia TensorRT-LLM 
...
[Section titled “TensorRT-LLM Environment Setup”](https://developers.llamaindex.ai/python/examples/llm/nvidia_tensorrt/#tensorrt-llm-environment-setup)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/nvidia_tensorrt/#basic-usage)
#### Call `complete` with a prompt
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/nvidia_tensorrt/#call-complete-with-a-prompt)
```
