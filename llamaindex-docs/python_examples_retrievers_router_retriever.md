[Skip to content](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#_top)
# Router Retriever 
...
### Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#setup)
...
### Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#download-data)
```
...
### Load Data
[Section titled “Load Data”](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#load-data)
...
[Section titled “Define Selector Module for Routing”](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#define-selector-module-for-routing)
...
#### PydanticSingleSelector
[Section titled “PydanticSingleSelector”](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#pydanticsingleselector)
```
...
#### PydanticMultiSelector
[Section titled “PydanticMultiSelector”](https://developers.llamaindex.ai/python/examples/retrievers/router_retriever/#pydanticmultiselector)
```
