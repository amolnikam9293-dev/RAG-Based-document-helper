[Skip to content](https://developers.llamaindex.ai/python/examples/llm/cohere/#_top)
# Cohere 
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/cohere/#basic-usage)
#### Call `complete` with a prompt
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/cohere/#call-complete-with-a-prompt)
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/cohere/#call-chat-with-a-list-of-messages)
```
...
## Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/cohere/#streaming)
...
## Configure Model
[Section titled “Configure Model”](https://developers.llamaindex.ai/python/examples/llm/cohere/#configure-model)
```
...
## Async
[Section titled “Async”](https://developers.llamaindex.ai/python/examples/llm/cohere/#async)
```
...
[Section titled “Set API Key at a per-instance level”](https://developers.llamaindex.ai/python/examples/llm/cohere/#set-api-key-at-a-per-instance-level)
