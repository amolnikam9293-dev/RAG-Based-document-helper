[Skip to content](https://developers.llamaindex.ai/python/examples/llm/dashscope/#_top)
# DashScope LLMS 
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#basic-usage)
...
[Section titled “Initialize DashScope Object”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#initialize-dashscope-object)
```
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#call-complete-with-a-prompt)
```
...
[Section titled “Call `stream_complete“ with a prompt”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#call-stream_complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#call-chat-with-a-list-of-messages)
```
...
#### Using `stream_chat`
[Section titled “Using stream_chat”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#using-stream_chat)
```
...
[Section titled “Multiple rounds conversation.”](https://developers.llamaindex.ai/python/examples/llm/dashscope/#multiple-rounds-conversation)
```
