[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/chromaindexdemo/#_top)
# Chroma 
...
## Basic Example
[Section titled “Basic Example”](https://developers.llamaindex.ai/python/examples/vector_stores/chromaindexdemo/#basic-example)
...
[Section titled “Creating a Chroma Index”](https://developers.llamaindex.ai/python/examples/vector_stores/chromaindexdemo/#creating-a-chroma-index)
```
...
[Section titled “Basic Example (including saving to disk)”](https://developers.llamaindex.ai/python/examples/vector_stores/chromaindexdemo/#basic-example-including-saving-to-disk)
...
[Section titled “Basic Example (using the Docker Container)”](https://developers.llamaindex.ai/python/examples/vector_stores/chromaindexdemo/#basic-example-using-the-docker-container)
...
## Update and Delete
[Section titled “Update and Delete”](https://developers.llamaindex.ai/python/examples/vector_stores/chromaindexdemo/#update-and-delete)
