...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#setup-openai)
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#loading-documents)
...
### Create the Database
[Section titled “Create the Database”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#create-the-database)
...
### Set up the schema
[Section titled “Set up the schema”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#set-up-the-schema)
...
### Create the index
[Section titled “Create the index”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#create-the-index)
```
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#query-the-index)
...
### Metadata filters
[Section titled “Metadata filters”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#metadata-filters)
...
[Section titled “Download git commits dataset”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#download-git-commits-dataset)
```
...
[Section titled “Add nodes with custom metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#add-nodes-with-custom-metadata)
```
...
[Section titled “Apply metadata filters”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#apply-metadata-filters)
...
[Section titled “Apply nested filters”](https://developers.llamaindex.ai/python/examples/vector_stores/gel/#apply-nested-filters)
