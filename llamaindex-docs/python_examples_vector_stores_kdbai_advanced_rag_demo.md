[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#_top)
# Advanced RAG with temporal filters using LlamaIndex and KDB.AI vector store 
##### Note: This example requires a KDB.AI endpoint and API key. Sign up for a free [KDB.AI account](https://kdb.ai/get-started).
[Section titled “Note: This example requires a KDB.AI endpoint and API key. Sign up for a free KDB.AI account.”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#note-this-example-requires-a-kdbai-endpoint-and-api-key-sign-up-for-a-free-kdbai-account)
...
[Section titled “Install dependencies with Pip”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#install-dependencies-with-pip)
...
## Import dependencies
[Section titled “Import dependencies”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#import-dependencies)
```
...
[Section titled “Set OpenAI API key and choose the LLM and Embedding model to use:”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#set-openai-api-key-and-choose-the-llm-and-embedding-model-to-use)
```
...
[Section titled “Create KDB.AI session and table”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#create-kdbai-session-and-table)
```
...
[Section titled “Option 1. KDB.AI Cloud”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#option-1-kdbai-cloud)
...
[Section titled “Option 2. KDB.AI Server”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#option-2-kdbai-server)
...
[Section titled “Create the schema for your KDB.AI table”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#create-the-schema-for-your-kdbai-table)
...
[Section titled “Financial reports urls and metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#financial-reports-urls-and-metadata)
```
...
[Section titled “Download PDF files locally”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#download-pdf-files-locally)
```
...
[Section titled “Load local PDF files with LlamaIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#load-local-pdf-files-with-llamaindex)
```
...
[Section titled “Setup LlamaIndex RAG pipeline using KDB.AI vector store”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#setup-llamaindex-rag-pipeline-using-kdbai-vector-store)
```
...
[Section titled “Setup the LlamaIndex Query Engine”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#setup-the-llamaindex-query-engine)
```
...
[Section titled “Before the 2008 crisis”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#before-the-2008-crisis)
```
...
[Section titled “After the 2008 crisis”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#after-the-2008-crisis)
```
...
## In depth analysis
[Section titled “In depth analysis”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#in-depth-analysis)
```
...
[Section titled “Delete the KDB.AI Table”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#delete-the-kdbai-table)
...
#### Take Our Survey
[Section titled “Take Our Survey”](https://developers.llamaindex.ai/python/examples/vector_stores/kdbai_advanced_rag_demo/#take-our-survey)
