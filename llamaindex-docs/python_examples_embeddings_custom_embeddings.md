...
[Section titled “Custom Embeddings Implementation”](https://developers.llamaindex.ai/python/examples/embeddings/custom_embeddings/#custom-embeddings-implementation)
```
...
## Usage Example
[Section titled “Usage Example”](https://developers.llamaindex.ai/python/examples/embeddings/custom_embeddings/#usage-example)
```
...
#### Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/embeddings/custom_embeddings/#download-data)
```
...
#### Load Documents
[Section titled “Load Documents”](https://developers.llamaindex.ai/python/examples/embeddings/custom_embeddings/#load-documents)
```
