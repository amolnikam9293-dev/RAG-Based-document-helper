[Skip to content](https://developers.llamaindex.ai/python/examples/llm/vicuna/#_top)
# Replicate - Vicuna 13B 
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/llm/vicuna/#setup)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/vicuna/#basic-usage)
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/vicuna/#call-complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/vicuna/#call-chat-with-a-list-of-messages)
```
...
### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/vicuna/#streaming)
...
## Configure Model
[Section titled “Configure Model”](https://developers.llamaindex.ai/python/examples/llm/vicuna/#configure-model)
```
