[Skip to content](https://developers.llamaindex.ai/python/examples/llm/llm_predictor/#_top)
# LLM Predictor 
...
## LangChain LLM
[Section titled “LangChain LLM”](https://developers.llamaindex.ai/python/examples/llm/llm_predictor/#langchain-llm)
```
...
## OpenAI LLM
[Section titled “OpenAI LLM”](https://developers.llamaindex.ai/python/examples/llm/llm_predictor/#openai-llm)
```
