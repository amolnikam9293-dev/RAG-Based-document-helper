[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_auto_retriever/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_auto_retriever/#setup)
...
[Section titled “Defining Some Sample Data”](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_auto_retriever/#defining-some-sample-data)
...
[Section titled “Build Vector Index with Elasticsearch Vector Store”](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_auto_retriever/#build-vector-index-with-elasticsearch-vector-store)
...
[Section titled “Define VectorIndexAutoRetriever”](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_auto_retriever/#define-vectorindexautoretriever)
...
[Section titled “Running over some sample data”](https://developers.llamaindex.ai/python/examples/vector_stores/elasticsearch_auto_retriever/#running-over-some-sample-data)
