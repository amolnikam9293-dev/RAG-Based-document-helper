[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama-local/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama-local/#setup)
```
...
### Set Up
[Section titled “Set Up”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama-local/#set-up)
...
## Querying
[Section titled “Querying”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama-local/#querying)
```
...
### Streaming Support
[Section titled “Streaming Support”](https://developers.llamaindex.ai/python/examples/vector_stores/simpleindexdemollama-local/#streaming-support)
```
