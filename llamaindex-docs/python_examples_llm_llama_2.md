[Skip to content](https://developers.llamaindex.ai/python/examples/llm/llama_2/#_top)
# Replicate - Llama 2 13B 
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/llm/llama_2/#setup)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/llama_2/#basic-usage)
...
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/llama_2/#call-complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/llama_2/#call-chat-with-a-list-of-messages)
```
...
### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/llama_2/#streaming)
...
## Configure Model
[Section titled “Configure Model”](https://developers.llamaindex.ai/python/examples/llm/llama_2/#configure-model)
```
