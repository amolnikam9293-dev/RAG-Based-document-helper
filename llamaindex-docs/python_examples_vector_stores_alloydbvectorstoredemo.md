...
## Before you begin
[Section titled “Before you begin”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#before-you-begin)
...
[Section titled “🦙 Library Installation”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#-library-installation)
...
### 🔐 Authentication
[Section titled “🔐 Authentication”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#-authentication)
...
[Section titled “☁ Set Your Google Cloud Project”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#-set-your-google-cloud-project)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#basic-usage)
### Set AlloyDB database values
[Section titled “Set AlloyDB database values”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#set-alloydb-database-values)
...
[Section titled “AlloyDBEngine Connection Pool”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#alloydbengine-connection-pool)
...
[Section titled “AlloyDBEngine for AlloyDB Omni”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#alloydbengine-for-alloydb-omni)
...
### Initialize a table
[Section titled “Initialize a table”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#initialize-a-table)
...
#### Optional Tip: 💡
[Section titled “Optional Tip: 💡”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#optional-tip)
...
[Section titled “Create an embedding class instance”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#create-an-embedding-class-instance)
...
[Section titled “Initialize a default AlloyDBVectorStore”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#initialize-a-default-alloydbvectorstore)
```
...
### Download data
[Section titled “Download data”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#download-data)
```
...
### Load documents
[Section titled “Load documents”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#load-documents)
```
...
[Section titled “Use with VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#use-with-vectorstoreindex)
...
[Section titled “Initialize Vector Store with documents”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#initialize-vector-store-with-documents)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#query-the-index)
```
...
[Section titled “Create a custom Vector Store”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#create-a-custom-vector-store)
...
[Section titled “Add documents with metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#add-documents-with-metadata)
...
[Section titled “Search for documents with metadata filter”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#search-for-documents-with-metadata-filter)
...
## Add a Index
[Section titled “Add a Index”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#add-a-index)
...
### Re-index
[Section titled “Re-index”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#re-index)
```
...
### Remove an index
[Section titled “Remove an index”](https://developers.llamaindex.ai/python/examples/vector_stores/alloydbvectorstoredemo/#remove-an-index)
```
