[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/chroma_metadata_filter/#_top)
# Chroma Vector Store 
...
[Section titled “Creating a Chroma Index”](https://developers.llamaindex.ai/python/examples/vector_stores/chroma_metadata_filter/#creating-a-chroma-index)
```
...
[Section titled “One Exact Match Filter”](https://developers.llamaindex.ai/python/examples/vector_stores/chroma_metadata_filter/#one-exact-match-filter)
```
...
[Section titled “Multiple Exact Match Metadata Filters”](https://developers.llamaindex.ai/python/examples/vector_stores/chroma_metadata_filter/#multiple-exact-match-metadata-filters)
```
...
[Section titled “Multiple Metadata Filters with AND condition”](https://developers.llamaindex.ai/python/examples/vector_stores/chroma_metadata_filter/#multiple-metadata-filters-with-and-condition)
```
...
[Section titled “Multiple Metadata Filters with OR condition”](https://developers.llamaindex.ai/python/examples/vector_stores/chroma_metadata_filter/#multiple-metadata-filters-with-or-condition)
```
