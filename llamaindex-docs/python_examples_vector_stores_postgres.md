[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#_top)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#setup-openai)
...
### Loading documents
[Section titled “Loading documents”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#loading-documents)
...
### Create the Database
[Section titled “Create the Database”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#create-the-database)
...
### Create the index
[Section titled “Create the index”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#create-the-index)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#query-the-index)
...
[Section titled “Querying existing index”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#querying-existing-index)
```
...
### Hybrid Search
[Section titled “Hybrid Search”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#hybrid-search)
...
[Section titled “Improving hybrid search with QueryFusionRetriever”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#improving-hybrid-search-with-queryfusionretriever)
...
### Metadata filters
[Section titled “Metadata filters”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#metadata-filters)
...
[Section titled “Download git commits dataset”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#download-git-commits-dataset)
```
...
[Section titled “Add nodes with custom metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#add-nodes-with-custom-metadata)
```
...
[Section titled “Apply metadata filters”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#apply-metadata-filters)
...
[Section titled “Apply nested filters”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#apply-nested-filters)
...
### Customize queries
[Section titled “Customize queries”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#customize-queries)
...
[Section titled “PgVector Query Options”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#pgvector-query-options)
#### IVFFlat Probes
[Section titled “IVFFlat Probes”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#ivfflat-probes)
...
#### HNSW EF Search
[Section titled “HNSW EF Search”](https://developers.llamaindex.ai/python/examples/vector_stores/postgres/#hnsw-ef-search)
