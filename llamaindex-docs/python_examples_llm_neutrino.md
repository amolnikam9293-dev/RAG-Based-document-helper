[Skip to content](https://developers.llamaindex.ai/python/examples/llm/neutrino/#_top)
# Neutrino AI 
...
[Section titled “Set Neutrino API Key env variable”](https://developers.llamaindex.ai/python/examples/llm/neutrino/#set-neutrino-api-key-env-variable)
...
#### Using Your Router
[Section titled “Using Your Router”](https://developers.llamaindex.ai/python/examples/llm/neutrino/#using-your-router)
...
#### Streaming Responses
[Section titled “Streaming Responses”](https://developers.llamaindex.ai/python/examples/llm/neutrino/#streaming-responses)
```
