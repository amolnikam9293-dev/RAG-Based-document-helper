[Skip to content](https://developers.llamaindex.ai/python/examples/llm/litellm/#_top)
# LiteLLM 
...
[Section titled “LiteLLM supports 100+ LLM APIs (Anthropic, Replicate, Huggingface, TogetherAI, Cohere, etc.). Complete List”](https://developers.llamaindex.ai/python/examples/llm/litellm/#litellm-supports-100-llm-apis-anthropic-replicate-huggingface-togetherai-cohere-etc-complete-list)
#### Call `complete` with a prompt
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/litellm/#call-complete-with-a-prompt)
...
## Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/litellm/#streaming)
...
## Async
[Section titled “Async”](https://developers.llamaindex.ai/python/examples/llm/litellm/#async)
```
