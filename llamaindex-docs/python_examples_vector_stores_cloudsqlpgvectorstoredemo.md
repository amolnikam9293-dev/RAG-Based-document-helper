[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#_top)
...
## Before you begin
[Section titled “Before you begin”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#before-you-begin)
...
[Section titled “🦙 Library Installation”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#-library-installation)
...
### 🔐 Authentication
[Section titled “🔐 Authentication”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#-authentication)
...
[Section titled “☁ Set Your Google Cloud Project”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#-set-your-google-cloud-project)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#basic-usage)
### Set Cloud SQL database values
[Section titled “Set Cloud SQL database values”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#set-cloud-sql-database-values)
...
[Section titled “PostgresEngine Connection Pool”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#postgresengine-connection-pool)
...
### Initialize a table
[Section titled “Initialize a table”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#initialize-a-table)
...
#### Optional Tip: 💡
[Section titled “Optional Tip: 💡”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#optional-tip)
...
[Section titled “Create an embedding class instance”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#create-an-embedding-class-instance)
...
[Section titled “Initialize a default PostgresVectorStore”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#initialize-a-default-postgresvectorstore)
```
...
### Download data
[Section titled “Download data”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#download-data)
```
...
### Load documents
[Section titled “Load documents”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#load-documents)
```
...
[Section titled “Use with VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#use-with-vectorstoreindex)
...
[Section titled “Initialize Vector Store with documents”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#initialize-vector-store-with-documents)
...
### Query the index
[Section titled “Query the index”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#query-the-index)
```
...
[Section titled “Create a custom Vector Store”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#create-a-custom-vector-store)
...
[Section titled “Add documents with metadata”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#add-documents-with-metadata)
...
[Section titled “Search for documents with metadata filter”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#search-for-documents-with-metadata-filter)
...
## Add a Index
[Section titled “Add a Index”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#add-a-index)
...
### Re-index
[Section titled “Re-index”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#re-index)
```
...
### Remove an index
[Section titled “Remove an index”](https://developers.llamaindex.ai/python/examples/vector_stores/cloudsqlpgvectorstoredemo/#remove-an-index)
```
