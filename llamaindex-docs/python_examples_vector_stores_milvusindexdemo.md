[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#_top)
# Milvus Vector Store 
...
## Before you begin
[Section titled “Before you begin”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#before-you-begin)
### Install dependencies
[Section titled “Install dependencies”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#install-dependencies)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#setup-openai)
...
### Prepare data
[Section titled “Prepare data”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#prepare-data)
...
## Getting Started
[Section titled “Getting Started”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#getting-started)
### Generate our data
[Section titled “Generate our data”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#generate-our-data)
...
[Section titled “Create an index across the data”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#create-an-index-across-the-data)
...
### Query the data
[Section titled “Query the data”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#query-the-data)
...
## Metadata filtering
[Section titled “Metadata filtering”](https://developers.llamaindex.ai/python/examples/vector_stores/milvusindexdemo/#metadata-filtering)
