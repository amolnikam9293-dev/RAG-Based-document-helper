...
[Section titled “Creating a ClickHouse Client”](https://developers.llamaindex.ai/python/examples/vector_stores/clickhouseindexdemo/#creating-a-clickhouse-client)
```
...
[Section titled “Load documents, build and store the VectorStoreIndex with ClickHouseVectorStore”](https://developers.llamaindex.ai/python/examples/vector_stores/clickhouseindexdemo/#load-documents-build-and-store-the-vectorstoreindex-with-clickhousevectorstore)
...
#### Query Index
[Section titled “Query Index”](https://developers.llamaindex.ai/python/examples/vector_stores/clickhouseindexdemo/#query-index)
...
#### Clear All Indexes
[Section titled “Clear All Indexes”](https://developers.llamaindex.ai/python/examples/vector_stores/clickhouseindexdemo/#clear-all-indexes)
```
