[Skip to content](https://developers.llamaindex.ai/python/examples/llm/rungpt/#_top)
# RunGPT 
...
# Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/llm/rungpt/#setup)
...
## Basic Usage
[Section titled “Basic Usage”](https://developers.llamaindex.ai/python/examples/llm/rungpt/#basic-usage)
#### Call `complete` with a prompt
[Section titled “Call complete with a prompt”](https://developers.llamaindex.ai/python/examples/llm/rungpt/#call-complete-with-a-prompt)
```
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/rungpt/#call-chat-with-a-list-of-messages)
```
...
## Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/rungpt/#streaming)
