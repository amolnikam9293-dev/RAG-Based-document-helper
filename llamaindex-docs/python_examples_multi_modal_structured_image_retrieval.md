...
output =awaitpydantic_gemini(ReceiptInfo, img_docs, prompt_template_str)
...
outputs =awaitrun_jobs(tasks,show_progress=True,workers=5)
...
outputs =awaitaprocess_image_files(image_files)
