[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#setup)
...
[Section titled “Please provide OpenAI access key”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#please-provide-openai-access-key)
...
## Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#download-data)
```
...
[Section titled “Creating and populating the Vector Store”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#creating-and-populating-the-vector-store)
...
[Section titled “Initialize the Tencent Cloud VectorDB”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#initialize-the-tencent-cloud-vectordb)
...
## Querying the store
[Section titled “Querying the store”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#querying-the-store)
### Basic querying
[Section titled “Basic querying”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#basic-querying)
```
...
### MMR-based queries
[Section titled “MMR-based queries”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#mmr-based-queries)
...
[Section titled “Connecting to an existing store”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#connecting-to-an-existing-store)
...
[Section titled “Removing documents from the index”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#removing-documents-from-the-index)
...
## Metadata filtering
[Section titled “Metadata filtering”](https://developers.llamaindex.ai/python/examples/vector_stores/tencentvectordbindexdemo/#metadata-filtering)
