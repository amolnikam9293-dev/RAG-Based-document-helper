[Skip to content](https://developers.llamaindex.ai/python/examples/llm/konko/#_top)
# Konko 
...
[Section titled “Steps to Access Models”](https://developers.llamaindex.ai/python/examples/llm/konko/#steps-to-access-models)
...
[Section titled “Call chat with ChatMessage List”](https://developers.llamaindex.ai/python/examples/llm/konko/#call-chat-with-chatmessage-list)
...
[Section titled “Call chat with OpenAI Models”](https://developers.llamaindex.ai/python/examples/llm/konko/#call-chat-with-openai-models)
...
### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/konko/#streaming)
```
...
[Section titled “Call complete with Prompt”](https://developers.llamaindex.ai/python/examples/llm/konko/#call-complete-with-prompt)
```
...
## Model Configuration
[Section titled “Model Configuration”](https://developers.llamaindex.ai/python/examples/llm/konko/#model-configuration)
```
