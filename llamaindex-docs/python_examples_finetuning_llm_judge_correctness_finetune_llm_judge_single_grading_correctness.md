...
qrd = dataset_generator.generate_dataset_from_nodes=350)
...
num_train_questions =int(0.65*(qrd.qr_pairs))
...
gpt4_judge =CorrectnessEvaluator=gpt_4_llm)
...
ft_gpt_3p5_judge =CorrectnessEvaluator=ft_llm)
...
gpt_3p5_judge =CorrectnessEvaluator=gpt_3p5_llm)
