...
system_prompt_tool = FunctionTool.from_defaults=create_system_prompt)




get_tools_tool = FunctionTool.from_defaults=get_tools)




create_agent_tool = FunctionTool.from_defaults=create_agent)
