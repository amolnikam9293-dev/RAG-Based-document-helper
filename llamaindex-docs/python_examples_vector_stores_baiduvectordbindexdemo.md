[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#_top)
# Baidu VectorDB 
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#setup)
...
[Section titled “Please provide OpenAI access key”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#please-provide-openai-access-key)
...
## Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#download-data)
```
...
[Section titled “Creating and populating the Vector Store”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#creating-and-populating-the-vector-store)
...
[Section titled “Initialize the Baidu VectorDB”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#initialize-the-baidu-vectordb)
...
## Querying the store
[Section titled “Querying the store”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#querying-the-store)
### Basic querying
[Section titled “Basic querying”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#basic-querying)
```
...
### MMR-based queries
[Section titled “MMR-based queries”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#mmr-based-queries)
...
[Section titled “Connecting to an existing store”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#connecting-to-an-existing-store)
...
## Metadata filtering
[Section titled “Metadata filtering”](https://developers.llamaindex.ai/python/examples/vector_stores/baiduvectordbindexdemo/#metadata-filtering)
