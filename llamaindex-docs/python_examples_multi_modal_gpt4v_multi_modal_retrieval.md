[Skip to content](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#_top)
...
[Section titled “Download images from Tesla website for GPT4V image reasoning”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#download-images-from-tesla-website-for-gpt4v-image-reasoning)
```
...
[Section titled “Generate image reasoning from GPT4V Multi-Modal LLM”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#generate-image-reasoning-from-gpt4v-multi-modal-llm)
### Plot input images
[Section titled “Plot input images”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#plot-input-images)
```
...
[Section titled “Using GPT4V to understand those input images”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#using-gpt4v-to-understand-those-input-images)
```
...
[Section titled “Generating text, pdf, images data from raw files [Wikipedia, SEC files] for Multi Modal Index/Retrieval”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#generating-text-pdf-images-data-from-raw-files-wikipedia-sec-files-for-multi-modal-indexretrieval)
```
...
[Section titled “Build Multi-modal index and vector store to index both text and images”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#build-multi-modal-index-and-vector-store-to-index-both-text-and-images)
```
...
[Section titled “Retrieve and query texts and images from our Multi-Modal Index”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#retrieve-and-query-texts-and-images-from-our-multi-modal-index)
...
[Section titled “1. Retrieval-Augmented Captioning”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#1-retrieval-augmented-captioning)
```
...
**Node ID:** 8a67ab30-545c-46ee-a25f-64c95a4571be**Similarity:** 0.7758026357212682**Text:** == Reception == Consumer Reports wrote that the all-wheel-drive Model X 90D largely disappoints, as rear doors are prone to pausing and stopping, the second-row seats that cannot be folded, and the…
**Node ID:** 5db1e928-197d-41d4-b1c1-34d2bcf1cc4d**Similarity:** 0.7712850768830459**Text:** == Design and technology ==
...
**Node ID:** 89e533c6-3e25-4933-b58a-7d42ac67e957**Similarity:** 0.768609543932987**Text:** === Autoshift === Introduced in mid-2021, the Plaid and Long Range versions of the Model S feature no steering column-mounted shift stalk; instead, the Model S uses cameras to infer whether to shif…
```
...
[Section titled “2. Multi-Modal RAG Querying”](https://developers.llamaindex.ai/python/examples/multi_modal/gpt4v_multi_modal_retrieval/#2-multi-modal-rag-querying)
```
...
[n.metadata["file_path"]forin response.metadata["image_nodes"]]



```

**Node ID:** c9dac736-51ce-429a-9b77-96c95a00d91f**Similarity:** 0.8241315758378377**Text:** == Models == The Taycan is currently offered as a 4-door saloon model and a 4-door estate model, the Taycan Cross Turismo. Other planned variants include a two-door coupe and convertible models, wh…
**Node ID:** 531c87f5-fcc4-453e-a013-fa6c9a3a7d24**Similarity:** 0.822575963523647**Text:** The Porsche Taycan is a battery electric saloon and shooting brake produced by German automobile manufacturer Porsche. The concept version of the Taycan, named the Porsche Mission E, debuted at the…
