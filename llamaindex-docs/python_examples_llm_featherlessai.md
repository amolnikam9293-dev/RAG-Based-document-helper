[Skip to content](https://developers.llamaindex.ai/python/examples/llm/featherlessai/#_top)
# Featherless AI LLM 
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/llm/featherlessai/#setup)
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/examples/llm/featherlessai/#call-chat-with-a-list-of-messages)
```
...
### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/examples/llm/featherlessai/#streaming)
