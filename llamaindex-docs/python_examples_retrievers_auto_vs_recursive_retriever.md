[Skip to content](https://developers.llamaindex.ai/python/examples/retrievers/auto_vs_recursive_retriever/#_top)
...
[Section titled “Metadata Filters + Auto-Retrieval”](https://developers.llamaindex.ai/python/examples/retrievers/auto_vs_recursive_retriever/#metadata-filters--auto-retrieval)
...
[Section titled “Build Recursive Retriever over Document Summaries”](https://developers.llamaindex.ai/python/examples/retrievers/auto_vs_recursive_retriever/#build-recursive-retriever-over-document-summaries)
```
