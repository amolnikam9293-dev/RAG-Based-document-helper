[Skip to content](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#_top)
# **WordLift** Vector Store 
## Introduction
[Section titled “Introduction”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#introduction)
...
[Section titled “Key Features & Libraries:”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#key-features--libraries)
...
---  
# Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#setup)
```
...
[Section titled “Crawl the Website w/ Advertools”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#crawl-the-website-w-advertools)
```
...
[Section titled “Build the KG w/ WordLift 🕸”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#build-the-kg-w-wordlift)
```
...
# Run the show
[Section titled “Run the show”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#run-the-show)
```
...
[Section titled “Let’s query products in the KG now using GraphQL”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#lets-query-products-in-the-kg-now-using-graphql)
```
...
[Section titled “Leveraging the Knowledge Graph”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#leveraging-the-knowledge-graph)
...
[Section titled “Adding Structured Data to your Web Pages”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#adding-structured-data-to-your-web-pages)
...
[Section titled “Generating Links of Similar Products using WordLift Neural Search”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#generating-links-of-similar-products-using-wordlift-neural-search)
...
[Section titled “Building a Chatbot for the E-commerce Website using LlamaIndex 🦙”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#building-a-chatbot-for-the-e-commerce-website-using-llamaindex)
...
[Section titled “Installing LlamaIndex and WordLiftVectorStore 💪”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#installing-llamaindex-and-wordliftvectorstore)
```
...
[Section titled “Setting NomicEmbeddings for our Query Engine”](https://developers.llamaindex.ai/python/examples/vector_stores/wordliftdemo/#setting-nomicembeddings-for-our-query-engine)
