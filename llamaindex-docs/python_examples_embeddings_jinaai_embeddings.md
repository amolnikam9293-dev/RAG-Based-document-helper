...
[Section titled “Embed text and queries with Jina embedding models through JinaAI API”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#embed-text-and-queries-with-jina-embedding-models-through-jinaai-api)
...
[Section titled “Embed images and queries with Jina CLIP through JinaAI API”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#embed-images-and-queries-with-jina-clip-through-jinaai-api)
...
## Embed in batches
[Section titled “Embed in batches”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#embed-in-batches)
...
[Section titled “Let’s build a RAG pipeline using Jina AI Embeddings”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#lets-build-a-rag-pipeline-using-jina-ai-embeddings)
#### Download Data
[Section titled “Download Data”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#download-data)
```
...
#### Imports
[Section titled “Imports”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#imports)
```
...
#### Load Data
[Section titled “Load Data”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#load-data)
```
...
#### Build index
[Section titled “Build index”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#build-index)
```
...
#### Build retriever
[Section titled “Build retriever”](https://developers.llamaindex.ai/python/examples/embeddings/jinaai_embeddings/#build-retriever)
```
