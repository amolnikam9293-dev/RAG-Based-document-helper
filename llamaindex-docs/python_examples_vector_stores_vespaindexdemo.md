...
#### Setting up API key
[Section titled “Setting up API key”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#setting-up-api-key)
```
...
[Section titled “Load documents, build the VectorStoreIndex”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#load-documents-build-the-vectorstoreindex)
```
...
[Section titled “Defining some sample data”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#defining-some-sample-data)
...
[Section titled “Initilizing the VespaVectorStore”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#initilizing-the-vespavectorstore)
...
### Deleting documents
[Section titled “Deleting documents”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#deleting-documents)
```
...
## Querying
[Section titled “Querying”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#querying)
```
...
## As retriever
[Section titled “As retriever”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#as-retriever)
### Default query mode (text search)
[Section titled “Default query mode (text search)”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#default-query-mode-text-search)
```
...
### As query engine
[Section titled “As query engine”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#as-query-engine)
```
...
[Section titled “Using metadata filters”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#using-metadata-filters)
...
[Section titled “Abstraction level of this integration”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#abstraction-level-of-this-integration)
...
### The template
[Section titled “The template”](https://developers.llamaindex.ai/python/examples/vector_stores/vespaindexdemo/#the-template)
