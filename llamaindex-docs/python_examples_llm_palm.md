[Skip to content](https://developers.llamaindex.ai/python/examples/llm/palm/#_top)
# PaLM 
...
### Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/examples/llm/palm/#setup)
...
### Define Model
[Section titled “Define Model”](https://developers.llamaindex.ai/python/examples/llm/palm/#define-model)
```
...
[Section titled “Start using our PaLM LLM abstraction!”](https://developers.llamaindex.ai/python/examples/llm/palm/#start-using-our-palm-llm-abstraction)
```
